...
AVAILABLE_MODELS: dict[str, ModelConfig] = {
    ...
    "claude-opus-4": ModelConfig(
        ...
        model_id="claude-opus-4-20250715",
        tier=ModelTier.FLAGSHIP,
        max_tokens=32768,
    ...
    "llama3.2": ModelConfig(
        ...
        display_name="Llama 3.2 (Self-hosted)",
    ),
    "nomic-embed-text": ModelConfig(
        ...
        base_url="http://localhost:11434",
        embedding_dims=768,
        display_name="Nomic Embed Text (Self-hosted)",
    ),
    "llama-4-maverick": ModelConfig(
        ...
        supports_tools=True,
        base_url="http://localhost:11434",
        display_name="Llama 4 Maverick (Self-hosted)",
    ),
    "llama-3.3-70b": ModelConfig(
        ...
        supports_tools=True,
        base_url="http://localhost:11434",
        display_name="Llama 3.3 70B (Self-hosted)",
    ),
    ...
    "qwen3.5-397b": ModelConfig(
        ...
        supports_tools=True,
        base_url="http://localhost:11434",
        display_name="Qwen 3.5 397B (Self-hosted)",
    ),
    "mistral-large-2": ModelConfig(
        ...
        supports_tools=True,
        base_url="http://localhost:11434",
        display_name="Mistral Large 2 (Self-hosted)",
    ),
}
